...
public class MutiTileEntityAdamantiumLargeHeatExchanger extends TileEntityBase10MultiBlockBase implements IFluidHandler,
    ...
    public boolean checkStructure2() {
        ...
        if (worldObj.blockExists(tX - 1, tY, tZ - 1) && worldObj.blockExists(tX + 1, tY, tZ - 1)
            ...
            if (!ITileEntityMultiBlockController.Util.checkAndSetTarget(
                ...
                0,
                MultiTileEntityMultiBlockPart.ONLY_ITEM_FLUID_ENERGY_IN)) tSuccess = F;
            if (!ITileEntityMultiBlockController.Util.checkAndSetTarget(
                this,
                tX + 1,
                tY,
            ...
            if (!ITileEntityMultiBlockController.Util.checkAndSetTarget(
                ...
                getMultiTileEntityRegistryID(),
                0,
                MultiTileEntityMultiBlockPart.NOTHING)) tSuccess = F;
            if (!ITileEntityMultiBlockController.Util.checkAndSetTarget(
                this,
                tX + 1,
                tY + 1,
    ...
    static {
        LH.add(
            "gt.tooltip.multiblock.aheatexchanger.1",
            "3x3 Ring of 8 Heat Transmitters with Dense Tungsten Wall inside");
        LH.add("gt.tooltip.multiblock.aheatexchanger.2", "3x3 Ring of 8 Dense Tungsten Walls with Main inside");
        LH.add("gt.tooltip.multiblock.aheatexchanger.3", "Energy Output split over the 8 Heat Transmitters (Top)");
        LH.add("gt.tooltip.multiblock.aheatexchanger.4", "Input at Bottom Layer, Fluid Output at Main Block");
    }

    @Override
    public void addToolTips(List<String> aList, ItemStack aStack, boolean aF3_H) {
        aList.add(LH.Chat.CYAN + LH.get(LH.STRUCTURE) + ":");
        aList.add(LH.Chat.WHITE + LH.get("gt.tooltip.multiblock.aheatexchanger.1"));
        aList.add(LH.Chat.WHITE + LH.get("gt.tooltip.multiblock.aheatexchanger.2"));
        aList.add(LH.Chat.WHITE + LH.get("gt.tooltip.multiblock.aheatexchanger.3"));
        aList.add(LH.Chat.WHITE + LH.get("gt.tooltip.multiblock.aheatexchanger.4"));
    ...
    public String getTileEntityName() {
        return "gt.multitileentity.multiblock.adamantiumheatexchanger";
    }
}
